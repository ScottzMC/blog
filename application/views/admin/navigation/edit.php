...
<head>
    ...
    <?php foreach($edit_menu as $edt_mn){} ?>
    <title>Admin Dashboard || Edit <?php echo str_replace('-', ' ', $edt_mn->category); ?> Blog</title>
        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Edit Menu</h3>
                </div>
              ...
              <div class="row">
                  <div class="col-12">
                      <div class="card">
                          ...
                          <hr>
                          <form action="<?php echo base_url('admin/navigation/edit/'.$edt_mn->id); ?>" method="post" class="form-horizontal">
                              <div class="card-body">
                                  <h4 class="card-title">Edit Navigation</h4>
                                  <div class="form-group row">
                                      <label for="fname" class="col-sm-3 text-right control-label col-form-label">Menu Title</label>
                                      <div class="col-sm-9">
                                          <input type="text" class="form-control" name="category" value="<?php echo str_replace('-', ' ', $edt_mn->category); ?>">
                                      </div>
                                  </div>
                              </div>
                              <hr>
