    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo site_url('admin/comment/view'); ?>" aria-expanded="false">
                    <i class="mdi mdi-inbox"></i>
                    <span class="hide-menu">Post Comment</span>
                  </a>
                </li>
