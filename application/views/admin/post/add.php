...
<head>
    ...
    <title>Add Post|| Admin Blog</title>
        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Add Post</h3>
                </div>
              ...
              <div class="row">
                  <div class="col-12">
                      <div class="card">
                          ...
                          <hr>
                          <form action="<?php echo base_url('admin/post/add'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                              <div class="card-body">
